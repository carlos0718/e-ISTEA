...
export function createModal(producto) {
	...
	let template = `<div class="modal-dialog">
		...
		producto.title
	}" style="height: 350px; object-fit:scale-down;">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" onclick='guardarEnCarrito(${JSON.stringify(
									producto
								)})'><span><i class="bi bi-basket3"></i></span> Agregar a carrito</button>
                            </div>
                        </div>
                    </div>`;
